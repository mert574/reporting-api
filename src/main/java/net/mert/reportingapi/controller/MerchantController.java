...
public class MerchantController {
    ...
    public ResponseEntity<?> handleLogin(@Valid MerchantLoginRequest request, BindingResult result) {
        ...
        Optional<ResponseTemplate> token = merchantService.login(request);
        if (token.isPresent()) {
